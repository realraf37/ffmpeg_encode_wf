mkdir tm && cd tm &&
	...
	transmission-remote -t 1 -G all && transmission-remote -t 1 -g4 && transmission-remote -t 1 -f | grep Yes && transmission-remote -t 1 -s

export i=Bleach.E005.1080p.BluRay.HEVC.AAC2.0.x265-RB26DETT.mkv
export o=Bleach.E005.mkv
